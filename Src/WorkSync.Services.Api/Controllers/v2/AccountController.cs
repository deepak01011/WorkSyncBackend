...
using WorkSync.Infra.CrossCutting.Identity.Models.AccountViewModels;
...
namespace WorkSync.Services.Api.Controllers.V2;
...
public class AccountController : ApiController
{
    ...
    public async Task<IActionResult> Register(RegisterViewModel model)
    {
        ...
        // Add User
        var appUser = ApplicationUser.Create(model.Email, model.Email);
